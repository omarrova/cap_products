...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/omrv/autosfiori/test/integration/FirstJourney",
    "com/omrv/autosfiori/test/integration/carListJourney",
    "com/omrv/autosfiori/test/integration/carObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
